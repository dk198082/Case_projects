...
# also serves the built frontend (artifacts/production-priority-board) as
...
# variables (AZURE_PG_* or DATABASE_URL, SESSION_SECRET, APP_ORIGIN,
# ENTRA_TENANT_ID/ENTRA_CLIENT_ID/ENTRA_CLIENT_SECRET,
# ADMIN_CONSOLE_URL/ADMIN_CONSOLE_API_KEY, etc.) — none of those are baked
...
COPY artifacts/production-priority-board/package.json artifacts/production-priority-board/package.json
...
ENV PORT=4173
RUN BASE_PATH=/ pnpm --filter @workspace/production-priority-board run build
...
ENV PORT=8080
ENV STATIC_DIR=/repo/artifacts/production-priority-board/dist/public
